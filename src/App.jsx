...
=======
  ...
  function searchLyrics() {
    if (artist === "" || song === "") {
      return;
>>>>>>> fcc4bb8e57ef760eea0988e6ebd6fc10fab8c207
    }
      ...
      <div className="container flex min-h-screen min-w-screen">
        <div className="flex w-full flex-col text-center justify-center border border-green-400">
          ...
          <div className="flex flex-col sm:flex-row justify-center mb-4 sm:space-x-4">
            ...
            />
            <input
              className="p-2 bp-2 m-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              type="text"
              placeholder="Song name"
              onChange={(e) => {
          ...
          <div className="flex justify-center pb-5">
            <button
              className="w-32 bg-transparent hover:bg-blue-500 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent pb-5 rounded"
              onClick={() => searchLyrics()}
            >
              Search
            </button>
